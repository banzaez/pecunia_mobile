...
class FinanceCategories {
  ...
  static const FinanceCategory foodAndDrinks =
      FinanceCategory(12, "rfc_food_and_drinks", [
        FinanceCategory(121, "rfc_groceries", []),
        FinanceCategory(122, "rfc_restaurants_and_cafes", []),
      ]);

  static const FinanceCategory transport =
      FinanceCategory(13, "rfc_transport", [
  ...
  static const FinanceCategory housing = FinanceCategory(14, "rfc_housing", [
  ...
  static const FinanceCategory clothingAndFootwear = FinanceCategory(
    15,
    "rfc_clothing_and_footwear",
    [],
  );

  static const FinanceCategory health = FinanceCategory(16, "rfc_health", [
    FinanceCategory(161, "rfc_medicine", []),
    FinanceCategory(162, "rfc_insurance", []),
    FinanceCategory(163, "rfc_doctor_visits", []),
  ]);

  static const FinanceCategory entertainment =
      FinanceCategory(17, "rfc_entertainment", [
        FinanceCategory(171, "rfc_movies_and_theater", []),
        FinanceCategory(172, "rfc_travel_and_vacations", []),
        FinanceCategory(173, "rfc_hobbies", []),
      ]);

  static const FinanceCategory sportsAndFitness =
      FinanceCategory(18, "rfc_sports_and_fitness", [
        FinanceCategory(181, "rfc_gym_memberships", []),
        FinanceCategory(182, "rfc_sports_events", []),
      ]);

  static const FinanceCategory education =
      FinanceCategory(19, "rfc_education", [
        FinanceCategory(191, "rfc_courses_and_training", []),
        FinanceCategory(192, "rfc_learning_materials", []),
      ]);

  static const FinanceCategory loansAndDebts =
      FinanceCategory(20, "rfc_loans_and_debts", [
        FinanceCategory(201, "rfc_loan_payments", []),
        FinanceCategory(202, "rfc_loan_interest", []),
      ]);

  static const FinanceCategory pets = FinanceCategory(21, "rfc_pets", [
  ...
  // --------------------------------------------------------------------------------------------
  static const FinanceCategory transfer = FinanceCategory(
    27,
    "rfc_transfer",
    [],
  );
  ...
  static final List<FinanceCategory> incomeCategories =
      _buildIncomeCategories();

  static final List<FinanceCategory> expenseCategories =
      _buildExpenseCategories();

  static final List<FinanceCategory> allCategories = [
    ...incomeCategories,
    ...expenseCategories,
  ];

  static final Map<int, FinanceCategory> _cache = _buildCache();
